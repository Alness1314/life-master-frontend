...
import { getColumns } from "./VaultTableColumns"
import PropTypes from 'prop-types';

export default function Vault({ darkMode }) {
    ...
    const handleDetails = (id) => {
        navigate(`/vault/details/${id}`);
    };

    const handleUpdate = (id) => {
        navigate(`/vault/update/${id}`);
    };
