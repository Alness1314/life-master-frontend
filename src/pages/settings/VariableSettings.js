...
export default function VariableSettings({ darkMode }) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.REACT_APP_API_URL}${process.env.REACT_APP_API_PREFIX}/global-settings`, {
