...
export default function LinkConfig({ darkMode }) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.REACT_APP_API_URL}${process.env.REACT_APP_API_PREFIX}/measurementsystems/linkconfigurations`, {
    ...
    return (
        <div className="p-0 m-0">
            ...
            <Typography variant="paragraph" className={`mb-2 ${subTextColor}`}>
                Administra el enlace con cv360
            </Typography>
